...
$html = '<form class="continue-access-popup__form js-continue-access-form js-buy-programm-form">';
    ...
    foreach ($continue_checkboxes as $key => $checkbox) {
        if (!empty($checkbox['text']) && !empty($checkbox['price'])) {
            ...
            $html .= '<label class="continue-access-popup__checkbox">
                        <input ' . $checked . ' value="' . $key + 1 . '" required name="continue-period" type="radio">
