...
<div class="profile__panel-programm">
    <div class="container">
        ...
        <!-- ***************** Main accrodiont ***************** -->
        <div class="profile__panel-programm-accordion">
            <button class="profile__panel-programm-accordion-btn">
                <img class="profile__panel-programm-accordion-logo" src="" alt="logo">
                <div class="info-wrapper">
                    <p class="btn-title body-type-2 weight600">
                        Вирощування томатів в закритому грунті. Перший оберт
                    </p>
                    ...
                    <div class="progress-wrapper">
                        <div class="progress-info">
                            ...
                            Виконано <span class="current">0</span> з
                            <span class="all-programm">6</span> блоків
                        </div>
                        <svg class="progress-bar" xmlns="http://www.w3.org/2000/svg" width="161" height="5" viewBox="0 0 161 5" fill="none">
                            <rect width="161" height="5" transform="matrix(1 0 0 -1 0 5)" fill="#131614" />
                            <rect width="10" height="5" transform="matrix(1 0 0 -1 0 5)" fill="#53F07F" />
                        </svg>
                        <div class="expire">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
            ...
            <!-- ***************** Inner accrodiont ***************** -->
            <div class="profile__panel-programm-content">
                <div class="profile__panel-programm-block">
                    <button class="profile__panel-programm-block-btn">
                        <span class="body-type-0">Блок 1</span>
                        <span class="body-type-4 weight600">X Пройдено</span>
                    </button>
                    <div class="profile__panel-programm-block-content">
                        <div class="profile__panel-programm-block-video">
                            <video src=""></video>
                            <div class="video-name body-type-2 weight600">
                                Пасинкування та видалення листа
                            </div>
                            <button class="next-video-btn">
                                Наступне відео
                            </button>
                        </div>
                        <div class="profile__panel-programm-block-videos-list">
                            <button class="profile__panel-programm-block-video-btn body-type-4 weight600">
                                <span>Відео 1</span>
