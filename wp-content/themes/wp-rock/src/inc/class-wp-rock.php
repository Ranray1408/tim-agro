...
class WP_Rock
{
    ...
    public function stag_body_class($classes)
    {
        ...
        if ($is_lynx) {
            ...
            if ('MSIE 7.0' === $browser) {
                $browser_detect = 'ie7';
                $browser_detect .= ' ie';
            } else if ('MSIE 6.0' === $browser) {
                $browser_detect = 'ie6';
                $browser_detect .= ' ie';
            } else if ('MSIE 8.0' === $browser) {
                $browser_detect = 'ie8';
                $browser_detect .= ' ie';
            } else if ('MSIE 9.0' === $browser) {
                $browser_detect = 'ie9';
                $browser_detect .= ' ie';
            } else if ('MSIE 11.0' === $browser) {
                $browser_detect = 'ie11';
                $browser_detect .= ' ie';
            } else {
                $browser_detect = 'ie';
     ...
     *
     * @return string|null Embed url
     */
    public function px_get_youtube_embed_url($youtube_url): ?string
    {
        if (strripos($youtube_url, "youtube.com")) {
            parse_str(parse_url($youtube_url, PHP_URL_QUERY), $you);
            $youtube_id = $you["v"];
        } else if (strripos($youtube_url, "youtu.be")) {
            $you_mass = explode("/", $youtube_url);
     ...
     */
    public function get_youtube_iframe_data($youtube_url): ?string
    {
        $pattern =
     ...
     */
    public function ajax_front_to_backend($action_name, $callback_function, $is_private = false): void
    {
        if (!$is_private) {
     ...
     * @return void
     */
    public function px_site_setup(): void
    {
        /*
         ...
         * @return mixed
         */
        function add_svg_to_upload_mimes($upload_mimes): mixed
        {
     ...
     * @return void
     */
    public function px_remove_archive_word_from_title(): void
    {
        add_filter(
     ...
     */
    public function remove_cycling($p): array|string|null
    {
     ...
     * @return void
     */
    private function px_no_link_current_page(): void
    {
