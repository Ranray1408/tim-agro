...
if (function_exists('get_field')) {
    ...
    $page_class .= ' ' . $page_body_class . 'profile-page';
}
?>
...
<body <?php body_class($page_class); ?>>
    ...
    <div id="wrapper" class="wrapper">
        ...
        <?php echo esc_html( get_template_part( 'src/template-parts/profile', 'menu' ) ); ?>

        <?php echo esc_html( get_template_part( 'src/template-parts/custom-profile', 'header' ) ); ?>
